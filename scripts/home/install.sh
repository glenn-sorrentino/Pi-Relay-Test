...
collect_info() {
    ...
    bandwidth=$(whiptail --inputbox "Enter your desired bandwidth per second. It's recommended to share at least 2 MB" 8 78 "2 MB" --title "Bandwidth Rate" 3>&1 1>&2 2>&3)
    burst=$(whiptail --inputbox "Enter your burst rate per second." 8 78 "4 MB" --title "Bandwidth Burst" 3>&1 1>&2 2>&3)
    max=$(whiptail --inputbox "How much data would you like to share every month? It's recommended to share at least 200 GB." 8 78 "1.5 TB" --title "Accounting Max" 3>&1 1>&2 2>&3)
